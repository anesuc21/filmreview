...
export const Header = () => {
    ...
    return (
    <header>
        <nav className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-200 border-gray-200 shadow dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to ="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={Logo} className="h-12" alt="review" />
            <span className="self-center text-blue shadow-xl text-4xl font-bold whitespace-nowrap text-yellow-700 dark:text-yellow-300 p-3 rounded-lg dark:bg-gray-700 ">FilmScore</span>
        </Link>
